...
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/2d6cd657d4e338af4cd29-654e1c3ead7f1acc38.jpg')).split()  # Fsub pic
...
DREAMCINEZONE_MOVIE_UPDATE_CHANNEL = int(environ.get('DREAMCINEZONE_MOVIE_UPDATE_CHANNEL', ''))  # Notification of those who verify will be sent to your channel
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002019841747').split()]
