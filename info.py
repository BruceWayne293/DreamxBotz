...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002821416952').split()]  # Channel id for auto indexing (make sure bot is admin)
